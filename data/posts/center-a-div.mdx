...
description: "Centering things in CSS is hard"
...
I'm a big fan of <LinkPreview url="https://www.joshwcomeau.com/">
Josh Comeau's work</LinkPreview>. The like button on his blog is one 
of the most delightful UI elements I've come across. It's also a deceptively 
complex component (I honestly thought I could re-implement it in an hour, haha) that contains an SVG, sounds, mouse tracking, animations and of course, exploding confetti. 🎉
